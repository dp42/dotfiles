...
ln -nfs ~/src/github.com/dp42/dotfiles/peco $HOME/.config/peco
...
ln -nfs ~/src/github.com/dp42/dotfiles/.gitignore_global $HOME/.gitignore_global
ln -nfs ~/src/github.com/dp42/dotfiles/.ctags.d $HOME/.ctags.d
ln -nfs ~/src/github.com/dp42/dotfiles/.alacritty.yml $HOME/.alacritty.yml
